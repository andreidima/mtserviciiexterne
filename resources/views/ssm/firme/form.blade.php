        ...
        <div class="row mb-2 p-2 rounded-3" style="background-color: rgb(132, 236, 255)">
            ...
            <div class="col-lg-3 mb-2">
                ...
                <select name="ssm_stare_fise" class="form-select bg-white rounded-3 {{ $errors->has('domeniu_de_activitate_id') ? 'is-invalid' : '' }}">
                    ...
                    <option value="noi.p;de s.p" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'noi.p;de s.p' ? 'selected' : ''}}>noi.p;de s.p</option>
                    <option value="noi.p;de s" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'noi.p;de s' ? 'selected' : ''}}>noi.p;de s</option>
                    <option value="noi;de s" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'noi;de s' ? 'selected' : ''}}>noi;de s</option>
                    ...
                    <option value="comp.la cl." {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'comp.la cl.' ? 'selected' : ''}}>comp.la cl.</option>
                    <option value="cl;de s" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'cl;de s' ? 'selected' : ''}}>cl;de s</option>
                    <option value="cl.p;de s" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'cl.p;de s' ? 'selected' : ''}}>cl.p;de s</option>
                    <option value="Fișe-C" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'Fișe-C' ? 'selected' : ''}}>Fișe-C</option>
                    <option value="cl;control" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'cl;control' ? 'selected' : ''}}>cl;control</option>
                    ...
                    <option value="de adus" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'de adus' ? 'selected' : ''}}>de adus</option>
                    <option value="La anulate" {{ old('ssm_stare_fise', $firma->ssm_stare_fise) === 'La anulate' ? 'selected' : ''}}>La anulate</option>
                    @if (
            ...
            <div class="col-lg-3 mb-2">
                ...
                <select name="psi_stare_fise" class="form-select bg-white rounded-3 {{ $errors->has('domeniu_de_activitate_id') ? 'is-invalid' : '' }}">
                    <option value='-' selected>-</option>
                    <option value="noi.p;de s.p" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'noi.p;de s.p' ? 'selected' : ''}}>noi.p;de s.p</option>
                    <option value="noi.p;de s" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'noi.p;de s' ? 'selected' : ''}}>noi.p;de s</option>
                    <option value="noi;de s" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'noi;de s' ? 'selected' : ''}}>noi;de s</option>
                    ...
                    <option value="comp.la cl." {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'comp.la cl.' ? 'selected' : ''}}>comp.la cl.</option>
                    <option value="cl;de s" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'cl;de s' ? 'selected' : ''}}>cl;de s</option>
                    <option value="cl.p;de s" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'cl.p;de s' ? 'selected' : ''}}>cl.p;de s</option>
                    <option value="Fișe-C" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'Fișe-C' ? 'selected' : ''}}>Fișe-C</option>
                    <option value="cl;control" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'cl;control' ? 'selected' : ''}}>cl;control</option>
                    ...
                    <option value="de adus" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'de adus' ? 'selected' : ''}}>de adus</option>
                    <option value="La anulate" {{ old('psi_stare_fise', $firma->psi_stare_fise) === 'La anulate' ? 'selected' : ''}}>La anulate</option>
                    @if (
