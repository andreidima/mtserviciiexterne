...
<div class="container card" style="border-radius: 40px 40px 40px 40px;">
        <div class="row card-header align-items-center" style="border-radius: 40px 40px 0px 0px;">
            ...
            <div class="col-lg-6" id="app">
                <form class="needs-validation" novalidate method="GET" action="/firme">
                    ...
                    <div class="row input-group custom-search-form justify-content-center">
                        ...
                        <a class="btn btn-sm bg-secondary text-white col-md-4 border border-dark rounded-pill" href="/firme" role="button">
            ...
            <div class="col-lg-3 text-end">
                <a class="btn btn-sm bg-success text-white border border-dark rounded-pill col-md-8" href="/firme/adauga" role="button">
